...
export interface CtokenInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "_setImplementation(address,bool,bytes)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<boolean>,
      PromiseOrValue<BytesLike>
  ...
  encodeFunctionData(
    functionFragment: "delegateToImplementation(bytes)",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "delegateToViewImplementation(bytes)",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
