...
const NestList: React.FC = () => {
	...
	return (
		<NestListContainer>
			<ListLabelContainer>
				<ListLabelCol width={'15%'} align={'left'}>Nest Name</ListLabelCol>
				<ListLabelCol width={'42.5%'} align={'center'}>Underlying Assets</ListLabelCol>
				...
				<ListLabelCol width={'10%'} align={'center'}></ListLabelCol>
			</ListLabelContainer>
